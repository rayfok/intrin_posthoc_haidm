...
class ExitSurveyResponse(db.Model):
    ...
    task: str = db.Column(db.String(80), nullable=False)
    condition: str = db.Column(db.String(80), nullable=True)
    understandModel: str = db.Column(db.Text, nullable=False)
    improveDecisionMaking: str = db.Column(db.Text, nullable=False)
    modelUsage: str = db.Column(db.Text, nullable=False)
